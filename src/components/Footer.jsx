  ...
  return (
    <footer className='footer w-100 mt-5 bg-primary d-flex justify-content-around py-4 px-2 align-items-center'>
        ...
        <ul className='footerUl list-group list-group-flush'>
            <li><Link to='https://pokeapi.co/' target='_blank' className='text-light'>pokeapi.co</Link></li> 
            <li><Link to='https://reqres.in/' target='_blank' className='text-light'>reqres.in</Link></li>
            <li><Link to='https://jsonplaceholder.typicode.com/' target='_blank' className='text-light'>jsonplaceholder.typicode.com</Link></li>
        </ul>
